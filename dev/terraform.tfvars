...
environment             = "dev"  
cost_centre = "CC-1234511233"              # Environment name (dev/test/prod)
...
vm_size                 = "Standard_B2as_v2"    # VM size for AKS nodes
kubernetes_version      = "1.34.4"             # Kubernetes version for AKS cluster

# GitOps Configuration
gitops_repo_url  = "https://github.com/sdiqbalm-creator/gitops-configs.git" # GitOps repository for infrastructure configs (reference only)
argocd_namespace = "argocd"                                          # Namespace where ArgoCD will be deployed

# Application Deployment Configuration 
app_repo_url  = "https://github.com/sdiqbalm-creator/gitops-configs.git" # Repository containing your application manifests
